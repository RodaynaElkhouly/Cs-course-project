...
Q_CONSTINIT static const uint qt_meta_data_CLASSPipeENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Pipe::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSPipeENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSPipeENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPipeENDCLASS_t,
        // property 'x'
...
void *Pipe::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSPipeENDCLASS.stringdata0))
